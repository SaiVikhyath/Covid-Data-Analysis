...
IndiaVaccineData = VaccineData[VaccineData['State'] == 'Chhattisgarh']
...
('Chhattisgarh', firstDose, secondDose, firstDose, secondDose,))
conn.commit()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\ChattisgarhDoses.png')
pyplot.ion()
pyplot.close()
...
pyplot.xlabel('Days')
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\ChattisgarhFirstDose.png')
pyplot.ion()
pyplot.close()
...
pyplot.xlabel('Days')
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\ChattisgarhSecondDose.png')
pyplot.ion()
pyplot.close()
...
('Chhattisgarh', malesVaccinated, femalesVaccinated, transgendersVaccinated, malesVaccinated, femalesVaccinated, transgendersVaccinated,))
conn.commit()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\ChattisgarhGender.png')
pyplot.ion()
pyplot.close()
...
cur.execute('''insert into vaccine_distribution (state, covaxin_administered, covishield_administered)
 ...
 ('Chhattisgarh', covaxinAdministered, covishieldAdministered, covaxinAdministered, covishieldAdministered,))
conn.commit()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\ChattisgarhVaccine.png')
pyplot.ion()
pyplot.close()
