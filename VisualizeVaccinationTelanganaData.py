...
IndiaVaccineData = VaccineData[VaccineData['State'] == 'Telangana']
...
('Telangana', firstDose, secondDose, firstDose, secondDose,))
conn.commit()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\TelanganaDoses.png')
pyplot.ion()
pyplot.close()
...
pyplot.xlabel('Days')
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\TelanganaFirstDose.png')
pyplot.ion()
pyplot.close()
...
pyplot.xlabel('Days')
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\TelanganaSecondDose.png')
pyplot.ion()
pyplot.close()
...
('Telangana', malesVaccinated, femalesVaccinated, transgendersVaccinated, malesVaccinated, femalesVaccinated, transgendersVaccinated,))
conn.commit()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\TelanganaGender.png')
pyplot.ion()
pyplot.close()
...
cur.execute('''insert into vaccine_distribution (state, covaxin_administered, covishield_administered)
 ...
 ('Telangana', covaxinAdministered, covishieldAdministered, covaxinAdministered, covishieldAdministered,))
conn.commit()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\TelanganaVaccine.png')
pyplot.ion()
pyplot.close()
