...
IndiaVaccineData = VaccineData[VaccineData['State'] == 'Goa']
...
('Goa', firstDose, secondDose, firstDose, secondDose,))
conn.commit()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\GoaDoses.png')
pyplot.ion()
pyplot.close()
...
pyplot.xlabel('Days')
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\GoaFirstDose.png')
pyplot.ion()
pyplot.close()
...
pyplot.xlabel('Days')
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\GoaSecondDose.png')
pyplot.ion()
pyplot.close()
...
('Goa', malesVaccinated, femalesVaccinated, transgendersVaccinated, malesVaccinated, femalesVaccinated, transgendersVaccinated,))
conn.commit()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\GoaGender.png')
pyplot.ion()
pyplot.close()
...
cur.execute('''insert into vaccine_distribution (state, covaxin_administered, covishield_administered)
 ...
 ('Goa', covaxinAdministered, covishieldAdministered, covaxinAdministered, covishieldAdministered,))
conn.commit()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\GoaVaccine.png')
pyplot.ion()
pyplot.close()
