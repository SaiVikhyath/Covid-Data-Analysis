...
IndiaVaccineData = VaccineData[VaccineData['State'] == 'Mizoram']
...
('Mizoram', firstDose, secondDose, firstDose, secondDose,))
conn.commit()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\MizoramDoses.png')
pyplot.ion()
pyplot.close()
...
pyplot.xlabel('Days')
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\MizoramFirstDose.png')
pyplot.ion()
pyplot.close()
...
pyplot.xlabel('Days')
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\MizoramSecondDose.png')
pyplot.ion()
pyplot.close()
...
('Mizoram', malesVaccinated, femalesVaccinated, transgendersVaccinated, malesVaccinated, femalesVaccinated, transgendersVaccinated,))
conn.commit()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\MizoramGender.png')
pyplot.ion()
pyplot.close()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\MizoramVaccine.png')
pyplot.ion()
pyplot.close()
