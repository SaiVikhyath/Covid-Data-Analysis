...
IndiaVaccineData = VaccineData[VaccineData['State'] == 'Andaman and Nicobar Islands']
...
('Andaman & Nicobar', firstDose, secondDose, firstDose, secondDose,))
conn.commit()
...
cur.execute('''insert into vaccine_distribution (state, covaxin_administered, covishield_administered)
 ...
 ('Andaman & Nicobar', covaxinAdministered, covishieldAdministered, covaxinAdministered, covishieldAdministered,))
conn.commit()
