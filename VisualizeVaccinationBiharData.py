...
IndiaVaccineData = VaccineData[VaccineData['State'] == 'Bihar']
...
('Bihar', firstDose, secondDose, firstDose, secondDose,))
conn.commit()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\BiharDoses.png')
pyplot.ion()
pyplot.close()
...
pyplot.xlabel('Days')
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\BiharFirstDose.png')
pyplot.ion()
pyplot.close()
...
pyplot.xlabel('Days')
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\BiharSecondDose.png')
pyplot.ion()
pyplot.close()
...
('Bihar', malesVaccinated, femalesVaccinated, transgendersVaccinated, malesVaccinated, femalesVaccinated, transgendersVaccinated,))
conn.commit()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\BiharGender.png')
pyplot.ion()
pyplot.close()
...
cur.execute('''insert into vaccine_distribution (state, covaxin_administered, covishield_administered)
 ...
 ('Bihar', covaxinAdministered, covishieldAdministered, covaxinAdministered, covishieldAdministered,))
conn.commit()
...
pyplot.savefig(r'C:\Users\Mittu\Desktop\CovidDataAnalysis\Covid-Data-Analysis\Graphs\BiharVaccine.png')
pyplot.ion()
pyplot.close()
