...
IndiaVaccineData = VaccineData[VaccineData['State'] == 'Andhra Pradesh']
...
('Andhra Pradesh', firstDose, secondDose, firstDose, secondDose,))
conn.commit()
...
cur.execute('''insert into vaccine_distribution (state, covaxin_administered, covishield_administered)
 ...
 ('Andhra Pradesh', covaxinAdministered, covishieldAdministered, covaxinAdministered, covishieldAdministered,))
conn.commit()
